...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background-secondary/50 border-t border-primary/10 py-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-lg">Miras Mujeeb</span>
            </div>
            ...
            <div className="text-center">
              <p className="text-text-secondary">
                Made with{' '}
                <span className="text-red-500 inline-block animate-pulse">❤️</span> and lots of{' '}
